	...
	<body>
		...
		<div id="show-book" class="content scaffold-show" role="main">
			...
			<ol class="property-list book">
				...
				<g:if test="${bookInstance?.auther}">
				<li class="fieldcontain">
					<span id="auther-label" class="property-label"><g:message code="book.auther.label" default="Auther" /></span>
					
						<span class="property-value" aria-labelledby="auther-label"><g:fieldValue bean="${bookInstance}" field="auther"/></span>
